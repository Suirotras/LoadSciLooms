...
[`SciT_snakemake`](https://github.com/Suirotras/SciT_snakemake) pipeline**.
...
[LoadSciLooms web page](https://jari-van-diermen.github.io/LoadSciLooms/).
...
An lseurat object is a lightweight container that keeps data, parameters,
and models together.
...
SciT data often contains a mixture of real cells and background barcodes.
LoadSciLooms optionally performs Gaussian Mixture Model–based cell calling
using total transcript counts.
...
An example file can be found [here](https://github.com/Suirotras/LoadSciLooms/blob/master/inst/extdata/Odd_barcode_md.csv).
...
When using the gene symbols to create the seurat object, duplicate gene symbols become problematic.
Since Seurat does not allow duplicate feature names:
